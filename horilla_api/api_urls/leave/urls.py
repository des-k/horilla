...
urlpatterns = [
    ...
    path("leave-type/<int:pk>/icon/", LeaveTypeIconAPIView.as_view(), name="api-leave-type-icon"),
    ...
    path("allocation-request/<int:pk>/attachment/view/", LeaveAllocationRequestAttachmentViewAPIView.as_view(), name="api-leave-allocation-request-attachment-view"),
    path("allocation-request/<int:pk>/attachment/download/", LeaveAllocationRequestAttachmentDownloadAPIView.as_view(), name="api-leave-allocation-request-attachment-download"),
    ...
    path("request/<int:pk>/attachment/view/", LeaveRequestAttachmentViewAPIView.as_view(), name="api-leave-request-attachment-view"),
    path("request/<int:pk>/attachment/download/", LeaveRequestAttachmentDownloadAPIView.as_view(), name="api-leave-request-attachment-download"),
