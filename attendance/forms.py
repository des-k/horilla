...
def _ensure_single_session_activity(attendance: Attendance, prev_attendance_date: date | None = None) -> AttendanceActivity:
    ...
    The winning session metadata (channel/mode/image/location/request linkage)
    is mirrored from Attendance so API approvals behave like the web flow.
    """
    ...
    def put(self, request, pk):
        try:
            ...
            if attendance.requested_data is not None:
                ...
                try:
                    from attendance.views.requests import _mark_approved_request_channels
